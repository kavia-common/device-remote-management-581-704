package com.example.BackendServicesContainer;
...
@RestController
@Tag(name = "Hello Controller", description = "Basic endpoints for BackendServicesContainer")
public class HelloController {
    
    @GetMapping("/")
    @Operation(summary = "Welcome endpoint", description = "Returns a welcome message")
    public String hello() {
        return "Hello, Spring Boot! Welcome to BackendServicesContainer";
    }
    ...
    public String info() {
        return "Spring Boot Application: BackendServicesContainer";
    }
} 